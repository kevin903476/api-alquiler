...
switch ($method) {
    ...
    case "GET":
        // Llama al método para obtener todas las categorías
            ...
            $datos = $propietario->obtener_propietario();
            // Devuelve los datos en formato JSON
            echo json_encode($datos);
            break;
    case "PATCH":
            // Llama al método para insertar una nueva categoría
            $datos = $propietario->obtener_propietario_por_DNI($body["DNI"]);
    ...
    case "POST":
        // Llama al método para insertar una nueva categoría
        $datos = $propietario->insertar_propietario($body["DNI"], $body["nombre"],  $body["telefono"],  $body["email"]);
        // Devuelve una respuesta indicando que la inserción fue correcta
    ...
    case "PUT":
        ...
        $datos = $propietario->actualizar_propietario($body["DNI"], $body["nombre"],  $body["telefono"],  $body["email"]);
    ...
    case "DELETE":
        ...
        $datos = $propietario->eliminar_propietario($body["DNI"]);
